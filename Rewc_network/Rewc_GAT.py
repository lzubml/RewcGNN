...
class Rewc_GAT(torch.nn.Module):
    def __init__(self,
                 num_features,
                 num_classes,
                 dropout,
        ...
        for i in range(self.num_layers):
            ...
            cg_layer = GATConv(
                ...
                heads=2, add_self_loops=True, negative_slope=0.3,
                concat=True, dropout=0.2, bias=True, fill_value='add'
            )

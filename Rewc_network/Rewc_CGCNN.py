...
from torch_geometric.nn import CGConv, TopKPooling
from torch_geometric.nn import global_add_pool, global_max_pool, global_mean_pool


class Rewc_CGCNN(torch.nn.Module):
    def __init__(self,
                 num_features,
                 num_classes,
                 dropout,
        ...
        super(Rewc_CGCNN, self).__init__()
        ...
        for i in range(self.num_layers):
            ...
            cg_layer = CGConv(channels=(in_channel, out_channel), aggr='add')
